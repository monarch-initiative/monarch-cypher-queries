...
sed -e '/AGGREGATE_EVIDENCE_SOURCE_PROPS/ r aggregate-evidence.txt' -e s/AGGREGATE_EVIDENCE_SOURCE_PROPS//  owl-axioms.cql >> transform-graph.cql
sed -e '/AGGREGATE_EVIDENCE_SOURCE_PROPS/ r aggregate-evidence.txt' -e s/AGGREGATE_EVIDENCE_SOURCE_PROPS//  gene-gene.cql >> transform-graph.cql
